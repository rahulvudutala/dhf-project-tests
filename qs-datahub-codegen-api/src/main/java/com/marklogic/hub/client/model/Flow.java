...
public class Flow {
  ...
  **/
  ...
  public Flow steps(List<Object> steps) {
    this.steps = steps;
    return this;
  }

  public Flow addStepsItem(Object stepsItem) {
    if (this.steps == null) {
   ...
   /**
   * Array of summary Step objects associated with this Flow
   * @return steps
  **/
  @ApiModelProperty(value = "Array of summary Step objects associated with this Flow")
  ...
  public Flow jobs(List<String> jobs) {
    this.jobs = jobs;
    return this;
  }

  public Flow addJobsItem(String jobsItem) {
    if (this.jobs == null) {
